...
namespace Projeem.Controller
{
    public class Grupos
    {
        ...
        public decimal DeduzirRedundancia()
        {
            ...
            try
            {
                //Separa os 18 maiores
                string InstrucaoSql = "select top 36 * from grupos order by deducao_por_mvtc DESC";
                ...
                //Separa o menor dos 36
                lMvtc = Convert.ToDecimal(dt.Rows[35]["deducao_por_mvtc"].ToString()); //MVTC                
                //Verifica se é > zero; Se for faz a dedução do MVTC;
                if (lMvtc > 0)
                {
                    //Percorre os 36 maiores e 
                    //subtrai destes 36 o MVTC;
                    string vDed = "0";
        ...
        public string IsDebidoDeduzido(string gr, ref decimal vCreditoReal)
        {
            ...
            vCreditoReal = (Convert.ToDecimal(dt.Rows[0]["deducao_por_mvtc"].ToString()) * 36 );
            return vRetVal;
        }
        ...
        public bool PremioReal {
            get { return premioReal; }
            set { premioReal = value; }
        }
