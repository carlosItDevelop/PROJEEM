    ...
    public class Serie
    {
                                       ...
                                       ref Label p01, ref Label p02, ref Label p03, ref Label p04, ref Label p05, ref Label p115)
        {
            ...
            if (numReg > 0) {
                while (curReg < numReg) {
                    ...
                    CtrlGpDebito[(int)dt.Rows[curReg]["gr_01"]] += Convert.ToDecimal(aMapaCapi[vCar, 2]);
                    CtrlGpDebito[(int)dt.Rows[curReg]["gr_02"]] += Convert.ToDecimal(aMapaCapi[vCar, 2]);
                    CtrlGpDebito[(int)dt.Rows[curReg]["gr_03"]] += Convert.ToDecimal(aMapaCapi[vCar, 2]);
                    CtrlGpDebito[(int)dt.Rows[curReg]["gr_04"]] += Convert.ToDecimal(aMapaCapi[vCar, 2]);
                                    ...
                                    ref string[,] aMapaCapi, int car, ref decimal vLucroIndividual)
        {
            if (car <= 15)
            {
                ...
                CtrlGpCredito[gp_premiado] += Convert.ToDecimal(aMapaCapi[car, 5]);
                qtdePremio++;
