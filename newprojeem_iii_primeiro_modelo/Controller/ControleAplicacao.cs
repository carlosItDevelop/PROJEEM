...
namespace Projeem.Controller
{
    public class ControleAplicacao
    {
        ...
        public void Upd_Contabilidade(SqlConnection cnn, SqlTransaction tr, int id, int gp, string dbt_ctbil,
                        string dbt_real, string cto_ctbil,
                        string cto_real, string sdo_sb_ctbil,
                        string sdo_sb_real, string cg_subsidiario,
                        string sdo_ctbl_acum, string sdo_real_acum)
        ...
        public void AddEstatistica_Carencia(SqlConnection cnn, SqlTransaction tr, int id, int car1, int car2, int car3, int car4, 
            int car5, int car6, int car7, int car8, int car9, int car10, int car11, int car12, 
                                                    int car13, int car14, int car15, int proc115_qtde, decimal proc115_valor) 
            { 
            try {
                ...
                cmd.Parameters.Add(new SqlParameter("@proc115_qtde", proc115_qtde));
                cmd.Parameters.Add(new SqlParameter("@proc115_valor", proc115_valor));
        ...
        public void UpdEstatistica_Carencia(SqlConnection cnn, SqlTransaction tr, int id, int car1, int car2, int car3, int car4,
    int car5, int car6, int car7, int car8, int car9, int car10, int car11, int car12,
                                            int car13, int car14, int car15, int proc115_qtde, decimal proc115_valor)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("Upd_Estatistica_Carencia", cnn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Transaction = tr;
        ...
        public void UpdEstatistica_Premio(SqlConnection cnn, SqlTransaction tr, int id, int pre1, int pre2, int pre3, int pre4,
                                          int pre5, int pre6, int pre7, int pre8, int pre9,
                                          int pre10, int pre11, int pre12,
                                          int pre13, int pre14, int pre15)
        {
            try
            {
                SqlCommand cmd = new SqlCommand("Upd_Estatistica_Premio", cnn);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Transaction = tr;
        ...
        public static void DeleteAll_WithSProc(SqlConnection cn)
        {
            try
            {
                ...
                cmd = new SqlCommand("delete from estatistica_carencia", cn);
                cmd.ExecuteNonQuery();

                cmd = new SqlCommand("delete from estatistica_premio", cn);
                cmd.ExecuteNonQuery();
        ...
        void SetRst()
        {
            ...
            proc115_qtde = Convert.ToInt32(dt.Rows[curReg]["proc115_qtde"].ToString());
            proc115_valor = Convert.ToDecimal(dt.Rows[curReg]["proc115_valor"].ToString());
        ...
        public int Proc115_qtde
        {
            get { return proc115_qtde; }
            set { proc115_qtde = value; }
        }

        public decimal Proc115_valor
        {
            get { return proc115_valor; }
            set { proc115_valor = value; }
        }
