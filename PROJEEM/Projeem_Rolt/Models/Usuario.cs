...
namespace Models
{
    ...
    public class Usuario
    {
        ...
        private void Conectar()
        {
            try
            {
                // Este monte de (senha) eu fiz de propósito
                // para demostrar a riqueza de detalhes que envolvem
                // esta especificidade toda do C#.
                Senha senha = new Senha();        // Senha Objeto, senha instância;
                senha.Encripty(this.senha);         // Senha Instância, senha variável de instância;
                this.senha = senha.PwdCripty;    // Senha instância, senha propriedade;
