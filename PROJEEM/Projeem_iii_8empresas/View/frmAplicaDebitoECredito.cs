...
namespace Projeem.View
{
    public partial class frmAplicaDebitoECredito : Form
    {
        ...
        private string vServer = ConfigurationManager.AppSettings["servidor"];
        ...
        private void btnConsolidar_Click(object sender, EventArgs e)
        {
            ...
            while (vCountEmpresa < 8)
            {
                ...
                cnE = new SqlConnection("Data Source=" + vServer +  ";Initial Catalog=" + catalogo[vCountEmpresa] + ";Integrated Security=True;");
                try
                {
                    cnE.Open();
