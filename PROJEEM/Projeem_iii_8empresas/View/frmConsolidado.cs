...
namespace View
{
    public partial class frmConsolidado : Form
    {
        ...
        private string vDataBase = ConfigurationManager.AppSettings["database"];
        ...
        private void btnConfirmarConsolidado_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlConnection cn = new SqlConnection("Data Source=" + vServer + ";Initial Catalog=" + vDataBase + ";Integrated Security=True;");
        ...
        void ZeraContabil() {
            ...
            string[] catalogo = new string[8] { "Projeem_III_Empresa8", "Projeem_III_Empresa7", "Projeem_III_Empresa6", "Projeem_III_Empresa5", 
                                          "Projeem_III_Empresa4", "Projeem_III_Empresa3", "Projeem_III_Empresa2", "Projeem_III_Empresa1" };
            for (int k = 0; k < 8; k++) {
        ...
        private void frmConsolidado_Load(object sender, EventArgs e)
        {
            ...
            MyConn = new SqlConnection("Data Source=" + VServer + ";Initial Catalog=" + vDataBase + ";Integrated Security=True;");
            MyConn.Open();
