...
namespace Projeem.View
{
    public partial class frmMDIForm : Form
    {
        ...
        private void toolCboDatabase_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cboCn = new SqlConnection("Data Source=COOPERCHIP-PC;Initial Catalog=" + toolCboDatabase.Text + ";Integrated Security=True;");
            cboCn.Open();
        ...
        {
            //SqlConnection cn = new SqlConnection("Data Source=COOPERCHIP-PC;Initial Catalog=" + Indices.dbInUse + ";Integrated Security=True;");
            //try
            //{
            //    cn.Open();
        ...
        private void mnuGerarTodosOsDebitos_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection cn;
            for (int i = 0; i < 8; i++) {
                cn = new SqlConnection("Data Source=COOPERCHIP-PC;Initial Catalog=" + db[i] + ";Integrated Security=True;");
                cn.Open();
