...
namespace View
{
    public partial class frmConsolidado : Form
    {
        ...
        private void btnConfirmarConsolidado_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlConnection cn = new SqlConnection("Data Source=COOPERCHIP-PC;Initial Catalog=" + "newprojeem_consolidado" + ";Integrated Security=True;");
        ...
        void ZeraContabil() {
            ...
            for (int k = 0; k < 8; k++) {
                cn = new SqlConnection("Data Source=COOPERCHIP-PC;Initial Catalog=" + catalogo[k] + ";Integrated Security=True;");
                cn.Open();
        ...
        private void frmConsolidado_Load(object sender, EventArgs e)
        {
            ...
            MyConn = new SqlConnection("Data Source=COOPERCHIP-PC;Initial Catalog=" + "newprojeem_consolidado" + ";Integrated Security=True;");
            MyConn.Open();
